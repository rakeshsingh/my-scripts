    ...
    for entry in conn.entries:
        if 'member' in entry:
            for member in entry.member.values:
                ...
                if 'CN=Group' in member:  # Adjust this condition as needed to detect group DNs
...
if __name__ == "__main__":
    ...
    group_members = query_ad_groups(AD_SERVER, AD_USERNAME, AD_PASSWORD, AD_SEARCH_BASE, group_list)
