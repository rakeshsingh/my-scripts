...
def convert_csv_to_html(
    ...
    csvreader = csv.reader(inputstream, dialect="excel", delimiter=delim)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Converts CSV files into \
HTML tables"
    )
    parser.add_argument("inputfile", help="input file", default="", metavar="input")
    parser.add_argument(
        "-o",
        "--output",
        help="output file",
    ...
    parser.add_argument("-t", "--title", help="document & table title", default="")
    parser.add_argument(
        "-d",
        "--delimiter",
...
("%s" by default)'
    ...
    parser.add_argument(
        "-c",
        "--complete-document",
        help="output a complete HTML document instead of only the \
    table",
        action="store_true",
        default=False,
        dest="completedoc",
    ...
    parser.add_argument(
        "-g",
        "--force-htmlgen",
        help="uses HTMLgen even if the html module is available",
        action="store_true",
        default=False,
        dest="forcehtmlgen",
    )
